...
@media (max-width: 768px) {{
  ...
  .filter-group select {{ min-width: 80px; font-size: 12px; padding: 4px 8px; }}
  .multi-select {{ min-width: 90px; }}
  .multi-select-trigger {{ font-size: 12px; padding: 4px 8px; min-height: 26px; }}
  ...
  .view-tab {{ padding: 6px 12px; font-size: 12px; white-space: nowrap; flex-shrink: 0; }}
  ...
  /* Parent gantt */
  .parent-gantt-wrap .pg-header {{ padding: 8px; }}
